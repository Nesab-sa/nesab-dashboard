...
class _ProfitMarginsPageState extends State<ProfitMarginsPage> {
  ...
  static const _bankAliases = <String, String>{
    ...
    'مصرف الإنماء': 'بنك الإنماء',
    'بنك ساب': 'البنك السعودي البريطاني',
    'البنك السعودي الأول (ساب)': 'البنك السعودي البريطاني',
    'البنك السعودي الأول': 'البنك السعودي البريطاني',
    'بنك الاستثمار السعودي': 'البنك السعودي للاستثمار',
    'البنك الخليجي الدولي': 'بنك الخليج الدولي',
  };
