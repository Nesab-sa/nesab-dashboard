                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        MobileNavItem(
                          ...
                          label: 'الباقات',
                          currentSection: current,
                          section: DashboardSection.packages,
                          selectedSection: selectedSection,
                          textColor: textColor,
                        ),
                        MobileNavItem(
                        ...
                        MobileNavItem(
                          ...
                          label: 'محتوى التطبيق',
                          currentSection: current,
                          section: DashboardSection.appContent,
                          selectedSection: selectedSection,
                          textColor: textColor,
                        ),
                        MobileNavItem(
                        ...
                        MobileNavItem(
                          ...
                          label: 'الهيدر والصيانة',
                          currentSection: current,
                          section: DashboardSection.displaySettings,
                          selectedSection: selectedSection,
                          textColor: textColor,
                        ),
                        MobileNavItem(
                          ...
                          label: 'إدارة SEO',
                          currentSection: current,
                          section: DashboardSection.seoSettings,
                          selectedSection: selectedSection,
                          textColor: textColor,
                        ),
                        MobileNavItem(
                        ...
                        MobileNavItem(
                          ...
                          label: 'سجل العمليات',
                          currentSection: current,
                          section: DashboardSection.auditLog,
                          selectedSection: selectedSection,
                          textColor: textColor,
                        ),
                        MobileNavItem(
