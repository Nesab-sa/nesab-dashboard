...
const SAUDI_BANKS = [
  "بنك الراجحي", "البنك الأهلي السعودي", "بنك الجزيرة", "بنك ساب",
  "البنك السعودي الفرنسي", "مصرف الإنماء", "بنك الرياض",
  "البنك العربي الوطني", "بنك البلاد",
];

const PROFIT_MARGIN_PROMPT = `أنت محلل مالي متخصص في السوق السعودي.
ابحث عن هوامش الربح الحالية للبنوك السعودية التالية لثلاثة منتجات: شخصي، عقاري، تأجيري.
  ...
  "banks": [
    {
      ...
      "personal": { "min": 3.99, "max": 5.50, "available": true },
      "realEstate": { "min": 3.50, "max": 4.75, "available": true },
      "leasing": { "min": 4.00, "max": 6.00, "available": true }
    }
  ],
  "summary": "ملخص قصير عن أبرز التغييرات في هوامش الربح"
}

معرّفات البنوك: rajhi, snb, jazira, saab, fransi, inma, riyadh, anb, bilad.
استخدم أحدث المعلومات المتاحة. إذا لم تجد بيانات دقيقة لبنك معين، استخدم أقرب تقدير وضع available: true.`;
